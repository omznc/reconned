...
export function LanguageSwitcher(props: LanguageSwitcherProps) {
    ...
    const selectedCountry = props.countries.find((country) => country.iso2.toLocaleLowerCase() === language);
    ...
    return (
        <Select value={language} onValueChange={setLanguage}>
            ...
            <SelectContent>
                ...
                {props.countries
                    .filter((country) => VALID_LOCALES.includes(country.iso2.toLowerCase()))
                    .map((country) => (
                        <SelectItem key={country.iso2.toLowerCase()} value={country.iso2.toLowerCase()}>
                            {country.emoji ? (
