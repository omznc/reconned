...
import { membershipExtensionSchema, type MembershipExtensionFormValues } from "@/app/[locale]/dashboard/(club)/[clubId]/members/_components/membership-extension.schema";
                    ...
                    <div className="grid gap-4 py-4">
                        ...
                        {membership.startDate && (
                            <div className="grid gap-2">
                                ...
                                <div className="text-sm flex items-center gap-2">
                                    <span>{format(membership.startDate, "PPP", { locale: dateFnsLocale })}</span>
                                    <span className="text-xs text-muted-foreground">
                                        ({formatDistanceToNow(membership.startDate, { addSuffix: true, locale: dateFnsLocale })})
                                    </span>
                                </div>
                            </div>
                        )}
                        ...
                        {membership.endDate && (
                            <div className="grid gap-2">
                                ...
                                <div className="text-sm flex items-center gap-2">
                                    <span>{format(membership.endDate, "PPP", { locale: dateFnsLocale })}</span>
                                    <span className="text-xs text-muted-foreground">
                                        ({formatDistanceToNow(membership.endDate, { addSuffix: true, locale: dateFnsLocale })})
                                    </span>
                                </div>
                            </div>
                        )}
