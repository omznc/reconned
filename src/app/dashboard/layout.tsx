...
export default async function DashboardLayout(props: DashboardLayoutProps) {
	...
	const inviteRequestsCountByClub = await prisma.clubInvite.groupBy({
		by: ['clubId'],
		where: {
			status: "REQUESTED",
			club: {
	...
	return (
		<SidebarProvider>
			<CurrentClubProvider>
				<AppSidebar clubs={clubs} user={user} invitesCount={invitesCountForUser} inviteRequestsCount={inviteRequestsCountByClub} />
