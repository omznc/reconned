...
CREATE TABLE "User" (
	...
	"language" text DEFAULT 'bs' NOT NULL,
	"isPrivate" boolean DEFAULT false NOT NULL,
...
ALTER TABLE "Alliance" ADD CONSTRAINT "Alliance_countryId_fkey" FOREIGN KEY ("countryId") REFERENCES "public"."Country"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
ALTER TABLE "ClubAlliance" ADD CONSTRAINT "ClubAlliance_clubId_fkey" FOREIGN KEY ("clubId") REFERENCES "public"."Club"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
ALTER TABLE "ClubAlliance" ADD CONSTRAINT "ClubAlliance_allianceId_fkey" FOREIGN KEY ("allianceId") REFERENCES "public"."Alliance"("id") ON DELETE cascade ON UPDATE cascade;--> statement-breakpoint
...
CREATE UNIQUE INDEX "ClubAlliance_clubId_allianceId_key" ON "ClubAlliance" USING btree ("clubId" text_ops,"allianceId" int4_ops);--> statement-breakpoint
...
CREATE INDEX "ClubAuditLog_clubId_actionType_createdAt_idx" ON "ClubAuditLog" USING btree ("clubId" text_ops,"actionType" text_ops,"createdAt" timestamp_ops);--> statement-breakpoint
...
CREATE INDEX "ClubMembership_clubId_idx" ON "ClubMembership" USING btree ("clubId" text_ops);--> statement-breakpoint
CREATE INDEX "ClubMembership_userId_idx" ON "ClubMembership" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "ClubMembership_clubId_role_idx" ON "ClubMembership" USING btree ("clubId" text_ops,"role");--> statement-breakpoint
...
CREATE INDEX "Event_clubId_idx" ON "Event" USING btree ("clubId" text_ops);--> statement-breakpoint
CREATE INDEX "Event_dateStart_idx" ON "Event" USING btree ("dateStart" timestamp_ops);--> statement-breakpoint
CREATE INDEX "Event_clubId_dateStart_idx" ON "Event" USING btree ("clubId" text_ops,"dateStart" timestamp_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "EventInvite_token_key" ON "EventInvite" USING btree ("token" text_ops);--> statement-breakpoint
CREATE INDEX "EventRegistration_createdById_idx" ON "EventRegistration" USING btree ("createdById" text_ops);--> statement-breakpoint
CREATE INDEX "EventRegistration_eventId_idx" ON "EventRegistration" USING btree ("eventId" text_ops);--> statement-breakpoint
CREATE INDEX "EventRegistration_eventId_attended_idx" ON "EventRegistration" USING btree ("eventId" text_ops,"attended" bool_ops);--> statement-breakpoint
CREATE INDEX "_EventRegistrationToUser_B_index" ON "_EventRegistrationToUser" USING btree ("B" text_ops);--> statement-breakpoint
...
CREATE INDEX "Post_clubId_isPublic_idx" ON "Post" USING btree ("clubId" text_ops,"isPublic" bool_ops);--> statement-breakpoint
...
CREATE INDEX "Review_clubId_idx" ON "Review" USING btree ("clubId" text_ops);--> statement-breakpoint
CREATE INDEX "Review_userId_idx" ON "Review" USING btree ("userId" text_ops);--> statement-breakpoint
CREATE INDEX "Review_authorId_idx" ON "Review" USING btree ("authorId" text_ops);--> statement-breakpoint
CREATE INDEX "Review_createdAt_idx" ON "Review" USING btree ("createdAt" timestamp_ops);--> statement-breakpoint
