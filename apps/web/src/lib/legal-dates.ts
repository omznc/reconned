/**
 * Last substantive revision of each legal document. Lives outside the page modules
 * so the sitemap can report an honest `lastmod` without importing a React page.
 *
